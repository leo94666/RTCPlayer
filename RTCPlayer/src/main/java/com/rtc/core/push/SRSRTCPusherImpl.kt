...
import com.rtc.core.SRSRTCPusher
...
class SRSRTCPusherImpl(val context: FragmentActivity) : SRSRTCPusher(),
    ...
    override fun onLocalDescription(handleId: BigInteger?, sdp: SessionDescription?) {
        ...
        val url = NativeLib.instance.makePushUrl(app, streamId,Platform.SRS)
        logger("handleId: $url")
        val doPost = HttpClient.doSRSPost(
            url,
